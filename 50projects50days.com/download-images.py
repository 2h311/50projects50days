...
for project in projects[12:]:
	# project = projects[0]
	link = project['imgLink']
	url = f"https://50projects50days.com/img/projects-img/{link}"
	print(url)

	r = requests.get(url, stream=True)
	with open("../AppHazard/50projects50days.com/50projects50days.com/img/projects-img/"+link, 'wb') as f:
